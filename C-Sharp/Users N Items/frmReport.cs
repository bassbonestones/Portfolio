...
namespace Stones_Lab04
{
    ...
    {
        // This class is to create a form that displays the User's Item's information in a Crystal Report.
        ...
        private void frmReport_Load(object sender, EventArgs e)
        {
            ...
            // Refresh the viewer.
            crvUserItems.RefreshReport();
            // Create a new report document item.
            crUserItems report = new crUserItems();
            ...
            crvUserItems.ReportSource = report;
        }
