...
{
    public partial class frmTotalItemCost : Form
    {
        // This class is to create a form that displays Item Total Cost information in a Crystal Report.


        // Create flag to prevent navigation screen from appearing when the user is switching to the
        // update form.
        bool updating = false;
        public frmTotalItemCost()
        {
        ...
        private void frmTotalItemCost_Load(object sender, EventArgs e)
        {
            // Upon the load of this form, clear the current viewer, and set it to show the
            // user items Crystal Report.

            // Refresh the viewer.
            crvItemTotalCost.RefreshReport();
            // Create a new report document item.
            crItemTotalCost report = new crItemTotalCost();
            ...
            crvItemTotalCost.ReportSource = report;
        }
