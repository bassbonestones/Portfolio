...
{
    public partial class frmUserNetWorth : Form
    {
        // This class is to create a form that displays User Net Worth information in a Crystal Report.


        // Create flag to prevent navigation screen from appearing when the user is switching to the
        // update form.
        bool updating = false;
        public frmUserNetWorth()
        {
        ...
        private void frmUserNetWorth_Load(object sender, EventArgs e)
        {
            ...
            crvUserNetWorth.ReportSource = report;
        }
