...
int main()
{
	...
	mciSendString("open \"C:\\Program Files\\cpp\\Resources\\Sounds\\backgroundmusic.mp3\" type mpegvideo alias bgmusic", NULL, 0, NULL);
	// play file
...
bool WriteFileOut(crazy * &top)
{
	...
	{
		// open file
		writer.open("C:\\Program Files\\cpp\\Resources\\Data\\machines.dat", ios::binary | ios::out | ios::trunc);
...
bool ReadFileIn(crazy2 * &top)
{
	...
	try
	{
		...
		reader.open("C:\\Program Files\\cpp\\Resources\\Data\\machines.dat", ios::binary | ios::in);
		// end if error
		if (!reader.good())
