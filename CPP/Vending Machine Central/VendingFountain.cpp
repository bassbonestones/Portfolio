				...
				while (true)
				{
					...
					if (balance >= productSelectedPrice)
					{
						...
						if (choice2 == 1) 
						{
							...
							mciSendString("open \"C:\\Program Files\\cpp\\Resources\\Sounds\\cupcombined.mp3\" type mpegvideo alias mp3", NULL, 0, NULL);
							mciSendString("play mp3 from 0 wait", NULL, 0, NULL);
							mciSendString("close mp3", NULL, 0, NULL);
							...
							while (true)
							{
								...
								if (wantsIce != "y" && wantsIce != "Y" && wantsIce != "n" && wantsIce != "N")
									...
									if (wantsIce == "Y" || wantsIce == "y")
									{
										...
										mciSendString("open \"C:\\Program Files\\cpp\\Resources\\Sounds\\ice.mp3\" type mpegvideo alias mp3", NULL, 0, NULL);
										mciSendString("play mp3 from 0 wait", NULL, 0, NULL);
										mciSendString("close mp3", NULL, 0, NULL);
									}
								}
							...
							mciSendString("open \"C:\\Program Files\\cpp\\Resources\\Sounds\\fountainpour.mp3\" type mpegvideo alias mp3", NULL, 0, NULL);
							mciSendString("play mp3 from 0 wait", NULL, 0, NULL);
							mciSendString("close mp3", NULL, 0, NULL);
